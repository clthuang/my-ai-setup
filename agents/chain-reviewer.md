---
name: chain-reviewer
description: Validates artifact quality and chain sufficiency. Reviews phase outputs to ensure they contain everything the next phase needs. Read-only, no scope creep.
