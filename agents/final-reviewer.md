---
name: final-reviewer
description: Validates implementation matches original spec. Compares final code against spec.md to catch missing requirements, extra work, and misunderstandings. Read-only.
