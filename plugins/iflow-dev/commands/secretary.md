...
- anything else → Request handler (dispatches to iflow-dev:secretary agent)
...
1. **Read config** — Read `.claude/iflow-dev.local.md`. Extract `activation_mode`. If `yolo`, set YOLO prefix.
