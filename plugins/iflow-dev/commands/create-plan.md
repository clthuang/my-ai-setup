...
{Level 1}: design.md not found. Run /iflow-dev:design first.
{Level 2}: design.md appears empty or stub. Run /iflow-dev:design to complete it.
{Level 3}: design.md missing markdown structure. Run /iflow-dev:design to fix.
{Level 4}: design.md missing required sections (Components or Architecture). Run /iflow-dev:design to add them.
```
...
`/iflow-dev:create-tasks` with `[YOLO_MODE]` in args.
