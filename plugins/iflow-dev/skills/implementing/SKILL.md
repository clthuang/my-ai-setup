...
If all done: "All tasks complete. Run /iflow-dev:verify for quality review, then /iflow-dev:finish."
...
"Run /iflow-dev:verify for quality review."
"Run /iflow-dev:finish when ready to complete the feature."
