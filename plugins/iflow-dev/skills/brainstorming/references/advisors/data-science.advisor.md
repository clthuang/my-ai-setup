...
Example: If Base directory is `~/.claude/plugins/cache/m/iflow-dev/v/skills/brainstorming`, the references are at `~/.claude/plugins/cache/m/iflow-dev/v/skills/data-science-analysis/references/`.
