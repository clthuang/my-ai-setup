...
The workflow-artifacts.md file uses a table format linking feature artifacts. References use the `{iflow_artifacts_root}` config variable for project-aware path resolution:
