...
Example: If Base directory is `~/.claude/plugins/cache/m/iflow/v/skills/brainstorming`, replace `/brainstorming` with `/crypto-analysis` → `~/.claude/plugins/cache/m/iflow/v/skills/crypto-analysis/references/*.md`.
