...
Example: If Base directory is `~/.claude/plugins/cache/m/iflow/v/skills/brainstorming`, the references are at `~/.claude/plugins/cache/m/iflow/v/skills/crypto-analysis/references/`.
