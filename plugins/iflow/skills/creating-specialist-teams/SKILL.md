...
Create ephemeral specialist teams for complex tasks by injecting structured templates into `iflow:generic-worker` instances.
...
Located in `plugins/iflow/skills/creating-specialist-teams/references/`:
