...
- [ ] **T1.3.3: Implement trigger recreation — all 8 triggers**
  After RENAME, create all 8 triggers. **Existing 5** (copy exact DDL from Migration 1 `_create_initial_schema`):
  ```sql
