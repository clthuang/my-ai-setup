...
5. If before+after context is not uniquely matched in the original (zero matches or multiple matches) for any block, warn the user and degrade to Accept all / Reject.
